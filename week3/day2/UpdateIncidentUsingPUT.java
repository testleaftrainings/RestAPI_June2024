...
public class UpdateIncidentUsingPUT {
	...
	public void updateIncident() {
		...
		RequestSpecification inputRequest = RestAssured
				...
				.body("{\r\n"
						+ "    \"short_description\": \"Updating it in the put request\"\r\n"
						+ "}");

		
		Response response = inputRequest.when().put("2a2fdce6470382109555f884116d437a");
